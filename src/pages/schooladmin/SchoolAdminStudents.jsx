...
const initialPrimaryStudents = [
    { id: 'STU-001', name: 'Ivan Namukasa', class: 'P7A', age: 13, gender: 'Male',
      ...
      performance: 82, attendance: 94, fees: 'paid', joinDate: '2019-02-04', photo: 'https://images.unsplash.com/photo-1596495578065-6e0763fa1178?w=150&auto=format&fit=crop&q=80',
    ...
    { id: 'STU-002', name: 'Grace Mukasa', class: 'P6B', age: 12, gender: 'Female',
      ...
      performance: 91, attendance: 98, fees: 'paid', joinDate: '2019-02-04', photo: 'https://images.unsplash.com/photo-1595956553066-fe24a8c33395?w=150&auto=format&fit=crop&q=80',
      subjects: ['Mathematics', 'English', 'Science', 'Social Studies', 'Religious Education'],
      teachers: ['Mr. Kenneth Okello', 'Ms. Agnes Nassali', 'Mr. David Byaruhanga', 'Ms. Sarah Acen', 'Mr. Paul Kintu'],
      repeats: [],
      history: [
    ...
    { id: 'STU-004', name: 'Faith Ssali', class: 'P4B', age: 10, gender: 'Female',
      ...
      performance: 78, attendance: 92, fees: 'overdue', joinDate: '2021-02-01', photo: 'https://images.unsplash.com/photo-1588702547923-7093a6c3ba33?w=150&auto=format&fit=crop&q=80',
    ...
    { id: 'STU-006', name: 'Ruth Nabirye', class: 'P3A', age: 9, gender: 'Female',
      ...
      performance: 88, attendance: 100, fees: 'paid', joinDate: '2022-02-07', photo: 'https://images.unsplash.com/photo-1542810205-0a5b379f6a47?w=150&auto=format&fit=crop&q=80',
