...
const initialParents = [
    { id: 'PAR-001', name: 'Mary Namukasa', photo: 'https://images.unsplash.com/photo-1589156229687-496a31ad1d1f?w=150&auto=format&fit=crop&q=80', students: ['Ivan Namukasa (P6)', 'Sarah Namukasa (P3)'], phone: '+256 772 111222', email: 'mary.n@email.com', status: 'active', balance: 'UGX 365,000', leaveReason: '', leaveReturn: '', leaveNotes: '' },
    { id: 'PAR-002', name: 'John Mukasa', photo: 'https://images.unsplash.com/photo-1506277886164-e25aa3f4ef7f?w=150&auto=format&fit=crop&q=80', students: ['Peter Mukasa (P7)'], phone: '+256 752 333444', email: 'john.m@email.com', status: 'active', balance: 'UGX 0', leaveReason: '', leaveReturn: '', leaveNotes: '' },
    { id: 'PAR-003', name: 'Alice Kemigisha', photo: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=150&auto=format&fit=crop&q=80', students: ['Paul Kisa (P4)'], phone: '+256 701 555666', email: 'alice.k@email.com', status: 'inactive', balance: 'UGX 120,000', leaveReason: 'Relocated', leaveReturn: '', leaveNotes: 'Moved to Jinja' },
    { id: 'PAR-004', name: 'David Opio', photo: 'https://images.unsplash.com/photo-1522529599102-193c0d76b5b6?w=150&auto=format&fit=crop&q=80', students: ['Daniel Opio (P1)', 'Esther Opio (P2)'], phone: '+256 780 777888', email: 'david.o@email.com', status: 'active', balance: 'UGX 0', leaveReason: '', leaveReturn: '', leaveNotes: '' },
]
