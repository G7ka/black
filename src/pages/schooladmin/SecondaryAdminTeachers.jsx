...
const initialTeachers = [
    { id: 'TCH-S-001', name: 'Mr. Kenneth Okello', photo: 'https://images.unsplash.com/photo-1506277886164-e25aa3f4ef7f?w=150&auto=format&fit=crop&q=80', subject: 'Mathematics', class: 'S3, S4', phone: '+256 779 123456', email: 'k.okello@kps.ug', status: 'active', attendance: 96, leaveReason: '', leaveStart: '', leaveEnd: '', leaveNotes: '' },
    { id: 'TCH-S-002', name: 'Ms. Agnes Nassali', photo: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=150&auto=format&fit=crop&q=80', subject: 'English', class: 'S1, S2', phone: '+256 752 234567', email: 'a.nassali@kps.ug', status: 'active', attendance: 98, leaveReason: '', leaveStart: '', leaveEnd: '', leaveNotes: '' },
    { id: 'TCH-S-003', name: 'Mr. Ivan Byaruhanga', photo: 'https://images.unsplash.com/photo-1507152927692-a5b1154e9515?w=150&auto=format&fit=crop&q=80', subject: 'Physics', class: 'S5, S6', phone: '+256 701 345678', email: 'i.byaruhanga@kps.ug', status: 'on-leave', attendance: 88, leaveReason: 'Leave', leaveStart: '2026-02-15', leaveEnd: '2026-03-01', leaveNotes: 'Annual leave' },
    { id: 'TCH-S-004', name: 'Ms. Patricia Acen', photo: 'https://images.unsplash.com/photo-1589156229687-496a31ad1d1f?w=150&auto=format&fit=crop&q=80', subject: 'History', class: 'S3, S4', phone: '+256 780 456789', email: 'p.acen@kps.ug', status: 'active', attendance: 100, leaveReason: '', leaveStart: '', leaveEnd: '', leaveNotes: '' },
    { id: 'TCH-S-005', name: 'Mr. Samuel Waiswa', photo: 'https://images.unsplash.com/photo-1522529599102-193c0d76b5b6?w=150&auto=format&fit=crop&q=80', subject: 'Chemistry', class: 'S5, S6', phone: '+256 755 567890', email: 's.waiswa@kps.ug', status: 'active', attendance: 94, leaveReason: '', leaveStart: '', leaveEnd: '', leaveNotes: '' },
]
