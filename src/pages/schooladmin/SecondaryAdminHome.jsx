                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="card">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {[
                                { label: 'Fee Reminders', icon: Bell, color: 'bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-400 border-amber-200 dark:border-amber-800', path: '/schooladmin/secondary/fees' },
                                { label: 'View Reports', icon: FileText, color: 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 border-blue-200 dark:border-blue-800', path: '/schooladmin/secondary/reports' },
                                { label: 'Attendance', icon: AlertCircle, color: 'bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 border-red-200 dark:border-red-800', path: '/schooladmin/secondary/attendance' },
                                { label: 'Add Teacher', icon: Plus, color: 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 border-emerald-200 dark:border-emerald-800', path: '/schooladmin/secondary/teachers' },
                            ].map(a => (
