...
const history = [
    { id: 1, type: 'SMS', audience: 'All Parents', message: 'Dear Parent, this is a reminder that school fees balance is due March 1st. Please pay to avoid structural interruptions.', date: 'Feb 20, 2026', time: '14:30', status: 'Delivered' },
    { id: 2, type: 'App Notification', audience: 'P6 Teachers', message: 'Staff meeting tomorrow at 4:30 PM in the Main Hall.', date: 'Feb 18, 2026', time: '09:15', status: 'Delivered' },
...
export default function SchoolAdminAlerts() {
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="page-subtitle">Send bulk SMS, Emails, or App Notifications to your school community.</p>
                    </div>
                </div>
                        ...
                        <div className="card">
                            ...
                            <div className="space-y-5">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                            ...
                                            {['SMS', 'App Notification', 'Email'].map(type => (
                                                <button
                                                    ...
                                                    className={`py-2 px-3 rounded-lg border text-sm font-medium transition-all flex flex-col items-center gap-1
                                                        ${messageType === type ? 'bg-primary-50 border-primary-500 text-primary-700 ring-1 ring-primary-500' : 'bg-white border-slate-200 text-slate-600 hover:bg-slate-50'}`}
                                                >
                                                    {type === 'SMS' ? <MessageSquare size={16} /> : type === 'Email' ? <Mail size={16} /> : <Bell size={16} className={typeof Bell !== 'undefined' ? '' : 'hidden'} />}{ /* Bell fallback handled by just omitting logic if undefined, but we'll use AlertTriangle for App instead to be safe based on imports */}
                                                    {type === 'App Notification' && <Megaphone size={16} />}
                                                    {type}
                                                </button>
                                            ))}
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option>Specific Class (e.g. P1 - P7)</option>
                                ...
                                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-slate-100">
                                    ...
                                    <button className="btn-primary flex items-center gap-2 w-full sm:w-auto px-8 py-3 text-base" disabled={!message.trim()}>
