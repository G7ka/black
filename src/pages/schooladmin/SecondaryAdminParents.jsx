...
const initialSecondaryParents = [
    { id: 'PAR-S-001', name: 'Jane Namukasa', photo: 'https://images.unsplash.com/photo-1589156229687-496a31ad1d1f?w=150&auto=format&fit=crop&q=80', students: ['Mary Namukasa (S1B)', 'Patricia Nakato (S1A)'], phone: '+256 772 111222', email: 'jane.namukasa@mail.com', status: 'active', balance: 'UGX 450,000', leaveReason: '', leaveReturn: '', leaveNotes: '' },
    { id: 'PAR-S-002', name: 'Jane Doe', photo: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=150&auto=format&fit=crop&q=80', students: ['John Doe (S3A)'], phone: '+256 701 222333', email: 'jane.doe@mail.com', status: 'active', balance: 'UGX 0', leaveReason: '', leaveReturn: '', leaveNotes: '' },
    { id: 'PAR-S-003', name: 'Wendy Pan', photo: 'https://images.unsplash.com/photo-1594361879382-c1e893573553?w=150&auto=format&fit=crop&q=80', students: ['Peter Pan (S4A)'], phone: '+256 785 333444', email: 'wendy.pan@mail.com', status: 'active', balance: 'UGX 210,000', leaveReason: '', leaveReturn: '', leaveNotes: '' },
    { id: 'PAR-S-004', name: 'Catherine Wonderland', photo: 'https://images.unsplash.com/photo-1588702547923-7093a6c3ba33?w=150&auto=format&fit=crop&q=80', students: ['Alice Wonderland (S6)'], phone: '+256 754 444555', email: 'catherine.w@mail.com', status: 'active', balance: 'UGX 0', leaveReason: '', leaveReturn: '', leaveNotes: '' },
    { id: 'PAR-S-005', name: 'Robert Sserwanga', photo: 'https://images.unsplash.com/photo-1507152927692-a5b1154e9515?w=150&auto=format&fit=crop&q=80', students: ['Kenneth Sserwanga (S2A)'], phone: '+256 700 888999', email: 'robert.sser@mail.com', status: 'inactive', balance: 'UGX 0', leaveReason: 'Relocated', leaveReturn: '', leaveNotes: 'Moved overseas' },
]
